...
public:
    ...
    void setConnectionCallback(EpollConnCallBack cbFunc) {
        _connFunc = cbFunc;
    }
    void setMessageCallback(EpollConnCallBack cbFunc) {
        _msgFunc = cbFunc;
    }
    void setCloseCallback(EpollConnCallBack cbFunc) {
        _closeFunc = cbFunc;
    }
